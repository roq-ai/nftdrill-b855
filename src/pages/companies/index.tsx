...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'invitation.count', 'nft.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('invitation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('nft', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'nft',
          header: 'Nft',
          accessorKey: 'nft',
          cell: ({ row: { original: record } }: any) => record?._count?.nft,
        }
      : null,
